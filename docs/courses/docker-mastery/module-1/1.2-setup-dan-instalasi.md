...
-   **RAM:** Minimum 4GB (direkomendasikan 8GB+)
-   **CPU:** Intel chip atau Apple M1/M2
...
=== "Intel Mac" 1. Kunjungi [Docker Desktop for Mac](https://www.docker.com/products/docker-desktop/) 2. Pilih **"Mac with Intel chip"** 3. Download file `.dmg` (~500MB)

=== "Apple Silicon (M1/M2)" 1. Kunjungi [Docker Desktop for Mac](https://www.docker.com/products/docker-desktop/) 2. Pilih **"Mac with Apple chip"** 3. Download file `.dmg` (~400MB)
...
## ☁️ Instalasi di Virtual Machine
...
1. [**Menjalankan Container Pertama →**](1.3-your-first-container.md)
